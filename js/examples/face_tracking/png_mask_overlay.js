(function exampleCode() {
	...
	brfv4Example.updateCurrentExample = function(brfManager, imageData, draw) {
		...
		_image = _images[brfv4Example.imageno];
		changeImage(_image, brfv4Example.imageno);

	};

	function alertme()
	{
		console.log("Yo! I am alerted yo");
	}
	...
	var _imageURLs		= ["turnerassets/1.png",  "turnerassets/2.png"];
	var _imageScales	= [1.0, 2.0];
